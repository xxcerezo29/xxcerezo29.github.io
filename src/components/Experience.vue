...
import ExperienceItem from './partials/ExperienceItem.vue';
...
<template>
    <section id="experience" class="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
        ...
        <div>
            <ol class="group">
                <ExperienceItem v-for="(experience, index) in props.experiences" :key="index"
                    :experience="experience" />
            </ol>
            <div class="mt-12">
                <a class="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 font-semibold text-slate-200 group/link text-base"
                    href="/resume.pdf" target="_blank" rel="noreferrer noopener"
                    aria-label="View Full Résumé (opens in a new tab)"><span>View Full<!-- --> <span
                            class="inline-block">
                            Resume<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
