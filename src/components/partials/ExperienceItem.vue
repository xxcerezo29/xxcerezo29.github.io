    ...
    <li class="mb-12">
        ...
        <div
            ...
            <header class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2">
                {{ props.experience.start_year }} —
                {{ props.experience.end_year }}
            </header>
            <div class="z-10 sm:col-span-6">
                <h3 class="font-medium leading-snug text-slate-200">
                    <a :href="props.experience.company_url" target="_blank"
                        ...
                        <span>{{ props.experience.position }}
                ...
                <p class="mt-2 text-sm leading-normal">{{ props.experience.description }}
                </p>
                <ul class="mt-2 flex flex-wrap">
                    
                    <li v-for="(item, index) in props.experience.technologies" :key="index" class="mr-1.5 mt-2">
                        <div
